...
import GoogleCalendarScheduler from "./components/Calendar";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h1 className="text-4xl md:text-6xl font-bold text-purple-700 mb-6 leading-tight">
                Energy Storage,{" "}
                <span className="text-orange-500">Without the Headaches.</span>
              </h1>

              {/* Subline Pain Points */}
              <p className="text-lg text-gray-700 mb-6">
                We know the challenges are real: underperforming systems,
                interconnection delays, missed certifications, safety concerns,
                and improper sizing.{" "}
              ...
              <div className="flex flex-col sm:flex-row flex-wrap gap-4">
                ...
                <a
                  href="https://calendar.google.com/calendar/u/0/appointments/schedules/AcZssZ2GnP37dznaMlHrxXPkkDyrbhuJqd5j9dzZPqlqQS9zYRB8guO4FfDGh9E63-F9W_JzZv8AoyvF"
                  target="_blank"
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">sales@bessstrategies.com</p>
                    </div>
                  </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Visit us at booth</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3">
                    <Calendar className="h-5 w-5 text-orange-500" />
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="relative bg-gradient-to-br from-purple-50 to-orange-50 rounded-2xl shadow-lg p-10 md:p-14">
            ...
            <p className="text-xl md:text-2xl text-gray-700 leading-relaxed relative z-10">
              ...
              , where each project benefits from a pool of expertise rather than
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div>
              ...
              <p className="text-lg text-justify">
                ...
                trusted, independent advisor for organizations deploying battery
                energy storage systems. We believe energy storage is the
                backbone of the clean energy transition, but the journey from
                design to deployment is often clouded by compliance hurdles,
                regulatory delays, and technical uncertainties.
              </p>
              <p className="text-lg font-medium text-gray-800 mt-4">
                Our vision is clear:
              </p>
              <ul className="list-disc list-inside space-y-2 text-lg mt-2">
                <li>To simplify the complexity of energy storage projects.</li>
            ...
            <div>
              ...
              <p className="text-lg mt-4 text-justify">
                We work hand-in-hand with system owners, developers, and vendors
                to:
              </p>
              <ul className="list-disc list-inside space-y-2 text-lg mt-2">
                <li>
              ...
              <p className="text-lg mt-4 text-justify">
                ...
                storage project succeed—on time, on budget, and with confidence.
              </p>
            </div>
          </div>
        </div>
